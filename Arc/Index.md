...
<!-- Profile -->
      <div class="w3-white w3-text-grey w3-card-4">
        ...
        <div class="w3-container">
          ...
          <p title="Currently possess an International License"><i class="fa fa-car fa-fw w3-margin-right w3-large w3-text-teal" ></i> 12years Experience</p>
          <table style="width:100%">
            <tr>
              <td><p><i class="fa fa-linkedin fa-fw w3-margin-right w3-large w3-text-teal"></i><a href="https://www.linkedin.com/in/kowjw/"></a></p></td> <!-- LinkedIn-->
              <td><p><i class="fa fa-github fa-fw w3-margin-right w3-large w3-text-teal"></i><a href="https://github.com/jiredo"></a></p></td> <!-- Github Repo-->
              <td><p><i class="fa fa-google-plus fa-fw w3-margin-right w3-large w3-text-teal"></i><a href=https://scholar.google.com/citations?user=vYKEwHMAAAAJ&hl=en></a></p></td> <!-- GoogleScholar-->
            </tr>
          </table>
...
<!-- Technical Skills -->
          <p class="w3-large"><b><i class="fa fa-asterisk fa-fw w3-margin-right w3-text-teal"></i>Manufacturing Know-how</b></p>
          ...
          <p><i class="fa fa-check-square-o" aria-hidden="true"></i> Workshop/Machining</p>
          <p><i class="fa fa-check-square-o" aria-hidden="true"></i> Bespoke Manufacturing</p>
        <br>

<!-- Programming languages-->
          <p class="w3-large" style="width:auto"><b><i class="fa fa-asterisk fa-fw w3-margin-right w3-text-teal"></i>Programming Know-how</b></p>
          <!-- List -->
          <table style="width:100%">
          <tr>
...
<!-- Software Packages -->
          ...
          <tr>
            ...
            <td><p><i class="fa fa-object-ungroup" aria-hidden="true"></i> Obsidian</p></td> 
          </tr>
		      <tr>
            ...
            <td><p><i class="fa fa-cubes" aria-hidden="true"></i> Visual Code Studio</p></td>
		      ...
		      <tr>
            <td><p><i class="fa fa-trello" aria-hidden="true"></i> Trello</p></td>
            <td><p><i class="fa fa-slack" aria-hidden="true"></i> Slack</p></td>
          </tr>
		      </table>
        <br>
...
<!-- Off-time Actitivies -->
          ...
          <table style="width:100%">
          <tr>
          <td><p><i class="fa fa-plane" aria-hidden="true"></i> Travelling</p></td>
          <td><p><i class="fa fa-cutlery" aria-hidden="true"></i> Cooking</p></td>
          </tr>
          <tr>
          <td><p><i class="fa fa-male" aria-hidden="true"></i> Hiking</p></td>
          <td><p><i class="fa fa-hand-rock-o" aria-hidden="true"></i> Bouldering</p></td>
          </tr>
          <tr>
          <td><p><i class="fa fa-square" aria-hidden="true"></i> Badminton</p></td>
          <td><p><i class="fa fa-superpowers" aria-hidden="true"></i> Ultimate Frisbee</p></td>
          </tr>
		      </table>
          <br>
...
<!-- Right Column -->
    <div class="w3-twothird">
      ...
      <div class="w3-container w3-card w3-white w3-margin-bottom">
        ...
        <!-- Current -->
          <h5 class="w3-opacity"><b>Medical Device Development Engineer - Atlas Endoscopy, UK</b></h5>
        ...
        <!--RA-->
        <div class="w3-container">
          <h5 class="w3-opacity"><b>Research Associate in Medical Device Development - STORM Labs, UK</b></h5>
        ...
        <!--RA-SR-Storm-->
        <div class="w3-container">
        <h5 class="w3-opacity"><b>Research Assistant in Soft Robotic Devices - Surgical Technologies, UK</b></h5>
        ...
        <p>Developing new methods of sensing and actuation in soft robotics while aiding on-going research work for PhD students and staff. 
          <ul>
            <li>Res1</li>
            <li>Res2</li>
          </ul>
        ...
        <!--RA-SR-Intern-->
        <div class="w3-container">
        <h5 class="w3-opacity"><b>Research Internship - Surgical Technologies, UK</b></h5>
        ...
        <p>An EPSRC funded research internship project to develop soft robotics in the field of surgical technologies at the University. [See Below] 
          <ul>
            <li>Res1</li>
            <li>Res2</li>
          </ul>
        ...
        <!--TA-->
        <div class="w3-container">
          <h5 class="w3-opacity"><b>Teaching Assistant - Faculty of Engineering, University of Leeds, UK</b></h5>
          ...
          <p>Teaching assistant and Laboratory demonstrator to lecturers to provide guidance to students and oversee teaching materials during laboratory sessions. <br>
            Modules taught:
            <table style="width:100%;">
              <tr>
                <td>Year 1</td>
        ...
        <!--PM/STD-Guide-->
        <div class="w3-container">
        <h5 class="w3-opacity"><b>Peer Mentor / Student Guide - Faculty of Engineering, University of Leeds, UK</b></h5>
        ...
        <p>
          <ul>
            <li>Showcasing student projects and to help and guide parents and prospective students around the department.</li>
            <li>Pastoral support to first year students in the school at the University.</li>
          </ul> 
        </p><br>
        </div>
        <br>
...
<!-- Research/Academic Experience -->
      <div class="w3-container w3-card w3-white w3-margin-bottom">
        <h2 class="w3-text-grey w3-padding-16"><i class="fa fa-graduation-cap fa-fw w3-margin-right w3-xxlarge w3-text-teal"></i>Academic Qualifications</h2>
        <!-- PhD -->
        <div class="w3-container">
          <h4 class="w3-opacity"><b>PhD Soft Robotics in Surgical Technologies</b></h4>
          ...
          <p><a href="https://etheses.whiterose.ac.uk/27674/">Thesis Title:</a>  Development of a Fabrication Technique for Soft Planar Inflatable Composites <br>
            <ul>
              <li><h6 class="w3-text-teal"><i class="fa fa-trophy fa-fw w3-margin-right"></i>Leeds International Research Scholarship (LIRS)</h6></li>
              <li><h6 class="w3-text-teal"><i class="fa fa-trophy fa-fw w3-margin-right"></i>ESPRC Research Internship Scholarship</h6></li>
              <li><h6 class="w3-text-teal"><i class="fa fa-trophy fa-fw w3-margin-right"></i>'Best Presentation' - University of Leeds - Robotics Conference 2018</h6></li>
              <li><h6 class="w3-text-teal"><i class="fa fa-trophy fa-fw w3-margin-right"></i>'Best Poster'- University of Leeds - Post Graduate Researcher's Competition</h6></li>
            </ul>
          </p>
          <hr>
        </div>
        <!-- MSc -->
        <div class="w3-container">
          <h4 class="w3-opacity"><b>MSc Mechantronics & Robotics Engineering</b></h4>
          ...
          <p> <u>Dissertation Title:</u> Design and Development of an Intelligent Control for a Prosthetic Knee <br>
            <ul>
              <li><h6 class="w3-text-teal"><i class="fa fa-trophy fa-fw w3-margin-right"></i>'Overall Winner' - Poster Competition - MEIBioEng15</h6></li>
              <li><h6 class="w3-text-teal"><i class="fa fa-trophy fa-fw w3-margin-right"></i>1st Place - Rehabilitation Robotics - MEIBioEng15 </h6></li>
            </ul>
          </p>
          <hr>
        </div>
        <!-- BEng -->
        <div class="w3-container">
          <h4 class="w3-opacity"><b>BEng Mechantronics & Robotics Engineering</b></h4>
          <h5 class="w3-opacity"><b>University of Leeds, School of Electronics & Electrical Engineering (UK)</b></h5>
          ...
          <p> <u>Dissertation Title:</u> Artificial Intelligence  Based  Control  on  a  Solar  Energy  System <br>
            <ul>
              <li><h6 class="w3-text-teal"><i class="fa fa-trophy fa-fw w3-margin-right"></i>1st Place - 'Design & Manufacture Team Buggy Suspension Design, Build and Control Race' - <br> 
                &nbsp;&nbsp National Instruments (NI), UK </h6></li>
              <li><h6 class="w3-text-teal"><i class="fa fa-trophy fa-fw w3-margin-right"></i>1st Place - 'Computer in Engineering Analysis Programming Competition' - <br>
                &nbsp;&nbsp National Instruments (NI), UK </h6></li>
            </ul>
          </p>
          <br>
...
<!-- Engineering Projects (incl-ref to Published works)-->
      <div class="w3-container w3-card w3-white w3-margin-bottom">
        ...
        <h4 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i>2016 - 2020</h4>
        <div class="w3-container">
          <ul>
            <li><h5 class="w3-opacity">Development of a Fabrication Technique for Soft Planar Inflatable Composites</h5>
            <!--Thin soft layering technique-->
            </li>
            <li><h5 class="w3-opacity">Development and Fabrication of a Magnetic Soft Tri-Axis Tactile Sensor</h5>
            <!--Publication Icon at the end?-->
            </li>
            <li><h5 class="w3-opacity">Computation design tools for soft sensors</h5>
            <!--Publication Icon at the end?-->
            </li>
            <li><h5 class="w3-opacity">Fabrication of a dynamic vascular prosthesis for Fontan procedures</h5></li>
            <li><h5 class="w3-opacity">Fabrication of a soft reactive bio-incubator for muscle cell growth</h5></li>
          </ul>
        </div><!--End -->
        <h4 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i>2015 - 2016</h4>
        <div class="w3-container">
          <ul>
            <li><h5 class="w3-opacity">SR Internship</h5>
            <!--Thin soft layering technique-->
            </li>
            <li><h5 class="w3-opacity">Prosthetic Knee</h5>
            <!--Publication Icon at the end?-->
...
<!-- Certification -->
      <div class="w3-container w3-card w3-white w3-margin-bottom">
	      <h2 class="w3-text-grey w3-padding-16"><i class="fa fa-file-code-o fa-fw w3-margin-right w3-xxlarge w3-text-teal"></i>Certifications & Achievements</h2>
        <h4 class="w3-opcaity"><b>Certification</b></h4>
        <div class="w3-container">
	      </div><!--End -->
        <br>
        <h4 class="w3-opcaity"><b>Achievements</b></h4>
        <div class="w3-container">
	      </div><!--End -->
      </div><!--End -->

<!-- Tinkering/3D Printer -->
      <div class="w3-container w3-card w3-white w3-margin-bottom">
